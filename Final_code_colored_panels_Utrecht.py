...
def process_data(data, amount_of_points_skipped,shift,points_capped):
    """interpolate reflection, transmission and quantum efficiency data"""
    processed = {}
    
    # Wavelengths array from data
    wavelengths = data['solar_spectrum'][amount_of_points_skipped:points_capped, 0]
...
def calculate_spectra(amount_of_points_skipped,processed, data_solar_spectrum, points_capped):
    """Calculate various spectra based on processed data"""
    spectra = {}
    
    # solar spectrum from data
    solar_spectrum=data_solar_spectrum[amount_of_points_skipped:points_capped,1]
